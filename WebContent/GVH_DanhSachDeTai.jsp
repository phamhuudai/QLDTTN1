				...
				<div class="well">
					<div class="form-login" role="form" action="">
						...
						<div class="form-group" style="background-color:#99FFFF">
							<i class="fa fa-pencil-square-o"></i><a class="active" href="#" class="group1">Danh sách đề tài<span class="fa arrow"></span></a>
						</div>
						<div class="form-group">
							<i class=" fa fa-bell-o"></i><a href="#" class="group1">Đánh giá quá trình<span class="fa arrow"></span></a>
						</div>
						<div class="form-group"  >
							<i class="fa fa-paste"></i><a href="#" class="group1" >Nhập điểm bảo vệ<span class="fa arrow"></span></a>
						</div>
						<div class="form-group">
							<i class="fa fa-pencil-square-o"></i><a href="#" class="group1">Quản lí báo cáo<span class="fa arrow"></span></a>
						</div>
						</div>
				</div>
			</div>
